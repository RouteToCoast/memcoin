            ...
            while (pc < pend && !newEvalFrameWasPushed) {
                ...
                if (fExec && 0 <= opcode && opcode <= OP_PUSHDATA4) {
                    ...
                    switch (opcode) {
                        ...
                        case OP_NOP3: {
                            // Memcoin: CSV disabled. Use nLockTime for time-locking.
                            return set_error(serror, ScriptError::BAD_OPCODE);
                        }
                        ...
                        case OP_RSHIFTNUM: {
                            ...
                            // since the op-code values corresponded to historical OP_2MUL/OP_2DIV (disabled by Bit).
                        ...
                        case OP_CHECKMULTISIGVERIFY:
                            // Memcoin: OP_CHECKMULTISIG disabled. Use MuSig instead.
                            return set_error(serror, ScriptError::BAD_OPCODE);
                        ...
                        case OP_OUTPUTBYTECODE: {
                            ...
                            switch (opcode) {
                                case OP_UTXOVALUE: {
                                    ...
                                    auto const bn = CScriptNum::fromInt(context->coinAmount(index) / BIT).value();
                                    stack.push_back(bn.getvch());
                                } break;
                                ...
                                case OP_OUTPUTVALUE: {
                                    ...
                                    auto const bn = CScriptNum::fromInt(output.nValue / BIT).value();
                                    stack.push_back(bn.getvch());
                                } break;
...
bool VerifyScript(const CScript &scriptSig, const CScript &scriptPubKey, uint32_t flags, const BaseSignatureChecker &checker,
    ...
    bool p2sh_32{}; (void)p2sh_32; // Memcoin: P2SH disabled
    const bool is_p2sh = false;   // Memcoin: P2SH disabled
