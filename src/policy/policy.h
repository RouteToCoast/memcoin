 ...
 */
static constexpr Amount DEFAULT_BLOCK_MIN_TX_FEE_PER_KB(1000 * BIT);
/**
 ...
 */
static constexpr CFeeRate MEMPOOL_FULL_FEE_INCREMENT(1000 * BIT);
/**
 ...
 */
static constexpr Amount DUST_RELAY_TX_FEE(1000 * BIT);
