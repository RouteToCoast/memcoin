 ...
 */
static const char *BITCOIN_PID_FILENAME = "memcoind.pid";
 ...
 * is shared between memcoind, and memcoin-qt and non-server tools.
 */
...
void SetupServerArgs() {
    ...
    gArgs.AddArg("-mempoolexpiry=<n>",
                 ...
                 ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    gArgs.AddArg("-mempoolminvalue=<n>",
                 strprintf("Reject transactions whose total output value "
                           "is below <n> bit (default: %d)",
                           DEFAULT_MEMPOOLMINVALUE),
                 ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    ...
    gArgs.AddArg(
        ...
        strprintf("Activation time of the November 2020 Memcoin Network Upgrade (<n> seconds since epoch, "
    ...
    gArgs.AddArg(
        ...
        strprintf("Activation height of the May 2023 Memcoin Network Upgrade; first block using new rules will be"
    ...
    gArgs.AddArg(
        ...
        strprintf("Activation height of the May 2024 Memcoin Network Upgrade; first block using new rules will be"
                  " after this height (default: %d, testnet: %d, testnet4: %d, scalenet: %d, chipnet: %d, regtest: %d)",
    ...
    gArgs.AddArg(
        ...
        strprintf("Activation height of the May 2025 Memcoin Network Upgrade; first block using new rules will be"
                  " after this height (default: %d, testnet: %d, testnet4: %d, scalenet: %d, chipnet: %d, regtest: %d)",
    ...
    gArgs.AddArg(
        ...
        strprintf("Activation time of the May 2026 Memcoin Network Upgrade (<n> seconds since epoch, "
                  "default: %d, chipnet: %d)",
    ...
    gArgs.AddArg(
        ...
        strprintf("Activation time of the tentative May 2027 Memcoin Network Upgrade (<n> seconds since epoch, "
                  "default: %d, chipnet: %d)",
...
std::string LicenseInfo() {
    ...
    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2026, COPYRIGHT_YEAR) + " ") +
           "\n\n" +
...
/** Sanity checks
 *  Ensure that Memcoin is running in a usable environment with all
