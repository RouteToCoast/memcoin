...
//! -fallbackfee default
static constexpr Amount DEFAULT_FALLBACK_FEE(20000 * BIT);
//! -mintxfee default
static constexpr Amount DEFAULT_TRANSACTION_MINFEE_PER_KB = 1000 * BIT;
//! minimum recommended increment for BIP 125 replacement txs
static constexpr Amount WALLET_INCREMENTAL_RELAY_FEE(5000 * BIT);
...
public:
     ...
     * on this memcoin node, and set to 0 for transactions that were created
...
public:
    ...
    void AvailableCoins(interfaces::Chain::Lock &locked_chain,
                        ...
                        const Amount nMinimumAmount = BIT,
