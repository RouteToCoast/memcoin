...
public:
    ...
    static constexpr Amount bit() { return Amount(1); }
...
inline constexpr Amount BIT = Amount::bit();
inline constexpr Amount COIN = int64_t(100000000) * BIT;

extern const std::string CURRENCY_UNIT;

/**
 * No amount larger than this (in bit) is valid.
 *
